...
namespace EZCoach.GridWorld {
    public class BoardsManager : MonoBehaviour {
        ...
        [SerializeField] private IntVector2 startingPosition;
        [SerializeField] private IntVector2[] endPoints;
        [SerializeField] private PositionReward[] rewards;
        [SerializeField] private float defaultActionReward;
        [SerializeField] private int maxMoves;
        [SerializeField] private float maxMovesReward;
